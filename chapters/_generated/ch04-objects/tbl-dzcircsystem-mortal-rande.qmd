<!-- indicator: tbl-dzcircsystem-mortal-rande -->

```{python}
#| echo: false
#| warning: false
#| message: false
#| label: tbl-dzcircsystem-mortal-rande
...
render_table_object(object_id="tbl-dzcircsystem-mortal-rande", workbook_path=CHA_WORKBOOK_PATH)
```
