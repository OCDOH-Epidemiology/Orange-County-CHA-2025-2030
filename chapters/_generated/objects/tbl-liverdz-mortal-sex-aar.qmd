<!-- indicator: tbl-liverdz-mortal-sex-aar -->

```{python}
#| echo: false
#| warning: false
#| message: false
#| label: tbl-liverdz-mortal-sex-aar
#| tbl-cap: 'Liver Disease and Cirrhosis Mortality, Age-Adjusted Rate per 100,000 by Sex, 2020–2023'
from scripts.cha_registry_renderer import render_table_object
render_table_object(object_id="tbl-liverdz-mortal-sex-aar", workbook_path=CHA_WORKBOOK_PATH)
```
