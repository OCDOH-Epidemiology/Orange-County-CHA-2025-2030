<!-- indicator: tbl-neoplasm-mortal-rande -->

```{python}
#| echo: false
#| warning: false
#| message: false
#| label: tbl-neoplasm-mortal-rande
#| tbl-cap: 'Malignant Neoplasm Mortality, Rate per 100,000 Population by Race and Ethnicity, 2020–2023'
from scripts.cha_registry_renderer import render_table_object
render_table_object(object_id="tbl-neoplasm-mortal-rande", workbook_path=CHA_WORKBOOK_PATH)
```
