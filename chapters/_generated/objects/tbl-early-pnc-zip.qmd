<!-- indicator: tbl-early-pnc-zip -->

```{python}
#| echo: false
#| warning: false
#| message: false
#| label: tbl-early-pnc-zip
#| tbl-cap: 'Percent of All Births with Early Prenatal Care, by ZIP Code, 2020–2023'
from scripts.cha_registry_renderer import render_table_object
render_table_object(object_id="tbl-early-pnc-zip", workbook_path=CHA_WORKBOOK_PATH)
```
