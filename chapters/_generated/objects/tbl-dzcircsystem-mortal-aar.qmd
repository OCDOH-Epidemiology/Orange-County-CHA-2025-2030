<!-- indicator: tbl-dzcircsystem-mortal-aar -->

```{python}
#| echo: false
#| warning: false
#| message: false
#| label: tbl-dzcircsystem-mortal-aar
...
render_table_object(object_id="tbl-dzcircsystem-mortal-aar", workbook_path=CHA_WORKBOOK_PATH)
```
