<!-- indicator: tbl-eng-learners-disav-disab -->

```{python}
#| echo: false
#| warning: false
#| message: false
#| label: tbl-eng-learners-disav-disab
...
render_table_object(object_id="tbl-eng-learners-disav-disab", workbook_path=CHA_WORKBOOK_PATH)
```
