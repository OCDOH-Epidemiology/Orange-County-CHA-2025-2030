<!-- indicator: tbl-premature-birth -->

```{python}
#| echo: false
#| warning: false
#| message: false
#| label: tbl-premature-birth
#| tbl-cap: 'Percentage of Premature Births, per 100 Live Births , 2020–2023'
from scripts.cha_registry_renderer import render_table_object
render_table_object(object_id="tbl-premature-birth", workbook_path=CHA_WORKBOOK_PATH)
```
