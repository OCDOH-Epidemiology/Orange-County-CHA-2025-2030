<!-- indicator: tbl-diseases-circ-mort-aar-zip -->

```{python}
#| echo: false
#| warning: false
#| message: false
#| label: tbl-diseases-circ-mort-aar-zip
#| tbl-cap: 'Diseases of the Circulatory System Mortality, Rate per 100,000 Population by ZIP Code, 2020–2023'
from scripts.cha_registry_renderer import render_table_object
render_table_object(object_id="tbl-diseases-circ-mort-aar-zip", workbook_path=CHA_WORKBOOK_PATH)
```
