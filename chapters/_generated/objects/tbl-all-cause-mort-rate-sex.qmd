<!-- indicator: tbl-all-cause-mort-rate-sex -->

```{python}
#| echo: false
#| warning: false
#| message: false
#| label: tbl-all-cause-mort-rate-sex
...
render_table_object(object_id="tbl-all-cause-mort-rate-sex", workbook_path=CHA_WORKBOOK_PATH)
```
