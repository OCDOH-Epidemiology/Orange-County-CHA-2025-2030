<!-- indicator: tbl-pneumoniaflu-count-rate-age-rande-zip -->

```{python}
#| echo: false
#| warning: false
#| message: false
#| label: tbl-pneumoniaflu-count-rate-age-rande-zip
#| tbl-cap: 'Pneumonia and Influenza Mortality, Case Counts and Rates per 100,000 Population by Age, Race and Ethnicity, and ZIP Code, 2020–2023'
from scripts.cha_registry_renderer import render_table_object
render_table_object(object_id="tbl-pneumoniaflu-count-rate-age-rande-zip", workbook_path=CHA_WORKBOOK_PATH)
```
