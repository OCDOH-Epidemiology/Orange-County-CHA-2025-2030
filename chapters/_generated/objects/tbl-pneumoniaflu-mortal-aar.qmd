<!-- indicator: tbl-pneumoniaflu-mortal-aar -->

```{python}
#| echo: false
#| warning: false
#| message: false
#| label: tbl-pneumoniaflu-mortal-aar
#| tbl-cap: 'Pneumonia and Influenza Mortality, Rate per 100,000 Population, 2020–2023'
from scripts.cha_registry_renderer import render_table_object
render_table_object(object_id="tbl-pneumoniaflu-mortal-aar", workbook_path=CHA_WORKBOOK_PATH)
```
