<!-- indicator: tbl-diseases-of-the-circulatory-sys -->

```{python}
#| echo: false
#| warning: false
#| message: false
#| label: tbl-diseases-of-the-circulatory-sys
...
render_table_object(object_id="tbl-diseases-of-the-circulatory-sys", workbook_path=CHA_WORKBOOK_PATH)
```
