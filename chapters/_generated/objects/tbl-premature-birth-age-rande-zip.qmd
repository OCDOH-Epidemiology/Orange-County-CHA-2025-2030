<!-- indicator: tbl-premature-birth-age-rande-zip -->

```{python}
#| echo: false
#| warning: false
#| message: false
#| label: tbl-premature-birth-age-rande-zip
#| tbl-cap: 'Premature Births, per 100 Live Births by Age, Race and Ethnicity, and ZIP Code, 2020–2023'
from scripts.cha_registry_renderer import render_table_object
render_table_object(object_id="tbl-premature-birth-age-rande-zip", workbook_path=CHA_WORKBOOK_PATH)
```
