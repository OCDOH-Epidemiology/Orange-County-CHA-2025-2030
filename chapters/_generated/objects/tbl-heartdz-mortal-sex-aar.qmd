<!-- indicator: tbl-heartdz-mortal-sex-aar -->

```{python}
#| echo: false
#| warning: false
#| message: false
#| label: tbl-heartdz-mortal-sex-aar
#| tbl-cap: 'Diseases of the Heart Mortality, Age-Adjusted Rate per 100,000 by Sex, 2020–2023'
from scripts.cha_registry_renderer import render_table_object
render_table_object(object_id="tbl-heartdz-mortal-sex-aar", workbook_path=CHA_WORKBOOK_PATH)
```
