<!-- indicator: tbl-all-cause-mortality-rate-zip -->

```{python}
#| echo: false
#| warning: false
#| message: false
#| label: tbl-all-cause-mortality-rate-zip
...
render_table_object(object_id="tbl-all-cause-mortality-rate-zip", workbook_path=CHA_WORKBOOK_PATH)
```
