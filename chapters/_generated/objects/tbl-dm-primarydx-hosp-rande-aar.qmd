<!-- indicator: tbl-dm-primarydx-hosp-rande-aar -->

```{python}
#| echo: false
#| warning: false
#| message: false
#| label: tbl-dm-primarydx-hosp-rande-aar
#| tbl-cap: 'Diabetes Hospitalizations as Primary Diagnosis, Age-Adjusted Rate per 10,000 Population by Race and Ethnicity, 2020–2022'
from scripts.cha_registry_renderer import render_table_object
render_table_object(object_id="tbl-dm-primarydx-hosp-rande-aar", workbook_path=CHA_WORKBOOK_PATH)
```
