<!-- indicator: tbl-gonorrhea-count-rate-sex-rande-age-zip -->

```{python}
#| echo: false
#| warning: false
#| message: false
#| label: tbl-gonorrhea-count-rate-sex-rande-age-zip
#| tbl-cap: 'Gonorrhea, Case Counts and Infection Rates per 100,000 by Sex, Race and Ethnicity, Age, and ZIP Code, 2021–2024'
from scripts.cha_registry_renderer import render_table_object
render_table_object(object_id="tbl-gonorrhea-count-rate-sex-rande-age-zip", workbook_path=CHA_WORKBOOK_PATH)
```
