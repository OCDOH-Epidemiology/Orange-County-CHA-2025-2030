<!-- indicator: tbl-early-pnc-age-rande-zip -->

```{python}
#| echo: false
#| warning: false
#| message: false
#| label: tbl-early-pnc-age-rande-zip
#| tbl-cap: 'All Births with Early Prenatal Care, by Age, Race and Ethnicity, and ZIP Code, 2020–2023'
from scripts.cha_registry_renderer import render_table_object
render_table_object(object_id="tbl-early-pnc-age-rande-zip", workbook_path=CHA_WORKBOOK_PATH)
```
