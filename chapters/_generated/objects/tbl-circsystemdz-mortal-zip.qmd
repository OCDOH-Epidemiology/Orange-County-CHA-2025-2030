<!-- indicator: tbl-circsystemdz-mortal-zip -->

```{python}
#| echo: false
#| warning: false
#| message: false
#| label: tbl-circsystemdz-mortal-zip
#| tbl-cap: 'Circulatory System Disease Mortality, Rate per 100,000 by ZIP Code, 2020–2023'
from scripts.cha_registry_renderer import render_table_object
render_table_object(object_id="tbl-circsystemdz-mortal-zip", workbook_path=CHA_WORKBOOK_PATH)
```
