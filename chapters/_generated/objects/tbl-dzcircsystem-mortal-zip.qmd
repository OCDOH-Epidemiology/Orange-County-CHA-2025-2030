<!-- indicator: tbl-dzcircsystem-mortal-zip -->

```{python}
#| echo: false
#| warning: false
#| message: false
#| label: tbl-dzcircsystem-mortal-zip
...
render_table_object(object_id="tbl-dzcircsystem-mortal-zip", workbook_path=CHA_WORKBOOK_PATH)
```
