<!-- indicator: tbl-fertility-rande -->

```{python}
#| echo: false
#| warning: false
#| message: false
#| label: tbl-fertility-rande
#| tbl-cap: 'Fertility, Rate per 1,000 Females Aged 15–44 Years by Race and Ethnicity, 2020–2023'
from scripts.cha_registry_renderer import render_table_object
render_table_object(object_id="tbl-fertility-rande", workbook_path=CHA_WORKBOOK_PATH)
```
