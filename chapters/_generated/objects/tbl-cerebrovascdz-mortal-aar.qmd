<!-- indicator: tbl-cerebrovascdz-mortal-aar -->

```{python}
#| echo: false
#| warning: false
#| message: false
#| label: tbl-cerebrovascdz-mortal-aar
...
render_table_object(object_id="tbl-cerebrovascdz-mortal-aar", workbook_path=CHA_WORKBOOK_PATH)
```
