<!-- indicator: tbl-other-d-csm-age-re-zip -->

```{python}
#| echo: false
#| warning: false
#| message: false
#| label: tbl-other-d-csm-age-re-zip
...
render_table_object(object_id="tbl-other-d-csm-age-re-zip", workbook_path=CHA_WORKBOOK_PATH)
```
