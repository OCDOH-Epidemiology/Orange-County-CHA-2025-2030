<!-- indicator: tbl-diseases-circ-mort-aar-sex -->

```{python}
#| echo: false
#| warning: false
#| message: false
#| label: tbl-diseases-circ-mort-aar-sex
...
render_table_object(object_id="tbl-diseases-circ-mort-aar-sex", workbook_path=CHA_WORKBOOK_PATH)
```
